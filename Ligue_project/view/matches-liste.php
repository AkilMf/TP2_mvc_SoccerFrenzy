    ...
    {% for matche in matches %}
        <div class="game">
            ...
            <div class="teams">
                ...
                {% if matche.equipe_Domicile == equipe.id %} {{ equipe.nom }} {% endif %}
                {% endfor %}
                </span>
                <span class="vs">vs</span>
                <span class="team-name">
                {% for equipe in equipes %}
                {% if matche.equipe_exterieur == equipe.id %} {{ equipe.nom }} {% endif %}
                {% endfor %}
                </span>
            </div>
            <div class="score">
            ...
            <div class="details"><!--j'obtiens le nom de la competition à partir de l'ID-->
                ...
                {% if matche.Competition_id == competition.id %} {{ competition.nom }} {% endif %}
                {% endfor %}
            </div>
